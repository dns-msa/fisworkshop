...
interface ChaosRecommendationStackProps extends cdk.StackProps {
  vpc: ec2.Vpc,
...
export class ChaosRecommendationStack extends cdk.Stack {
  public readonly recommendationAsg: asg.AutoScalingGroup;

  constructor(scope: cdk.Construct, id: string, props: ChaosRecommendationStackProps) {
